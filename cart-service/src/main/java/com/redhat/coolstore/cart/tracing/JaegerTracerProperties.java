...
public class JaegerTracerProperties {
	...
	public String toString() {
		return "JaegerTracerProperties [serviceName=" + serviceName + ", samplerType=" + samplerType + ", samplerParam="
				+ samplerParam + ", samplerManagerHostPort=" + samplerManagerHostPort + ", reporterLogSpans="
				+ reporterLogSpans + ", agentHost=" + agentHost + ", agentPort=" + agentPort
				+ ", reporterFlushInterval=" + reporterFlushInterval + ", reporterMaxQueueSize=" + reporterMaxQueueSize
				+ "]";
	}
